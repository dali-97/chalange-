                ...
                <div class="w-full lg:max-w-md">
                    ...
                    <ul>
                        ...
                        <li class="flex items-center py-2 space-x-4 xl:py-3">
                            ...
                            <span class="font-medium text-gray-500">Mobile Responsiveness</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img class="mx-auto sm:max-w-sm lg:max-w-full" src="https://cdn.pixabay.com/photo/2020/12/31/12/28/cook-5876388_960_720.png" alt="feature image">
            </div>
        </div>
    </div>
</section>
