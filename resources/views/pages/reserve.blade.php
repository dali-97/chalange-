...
<div class="flex gap-20 justify-center  ">
    <div class="block max-w-[18rem] rounded-lg bg-white text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
        <div class="p-6">
            <h5 class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
                Night Dish
            </h5>
            <p class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
               function will make the button desabled after the time is done
            </p>
